...
export const BurgerConstructorUI: FC<BurgerConstructorUIProps> = ({
  ...
  <section className={styles.burger_constructor} data-cy='burger-constructor'>
    {constructorItems.bun ? (
      <div className={`${styles.element} mb-4 mr-4`} data-cy='burger-constructor-bun-1'>
        <ConstructorElement
          type='top'
          isLocked
    ...
    <ul className={styles.elements} data-cy='burger-constructor-mains'>
    ...
    {constructorItems.bun ? (
      <div className={`${styles.element} mt-4 mr-4`} data-cy='burger-constructor-bun-2'>
        <ConstructorElement
          type='bottom'
          isLocked
    ...
    <div className={`${styles.total} mt-10 mr-4`} data-cy='button-container'>
